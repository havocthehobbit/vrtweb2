...
export const useScratchpadBE=(props)=>{ // { recname, apiNameSpace , ..rec..IDmain , ..rec..ChangeCB }
    let recName1="scratchpadBE";
    if (props){
        if (props.recname){
    ...
    let apiNameSpace1="scratchpadBE" ;
    
    let apiNameGetRecs="scratchpadBE" , useGetRecsInit=false ;
    ...
    let listRecs=(...args)=>{
        ...
        // scratchpadBEsList : { sendProps : { namespace : "scratchpad"
        if (props){
            if (props.scratchpadBEsList){
                if (props.scratchpadBEsList.sendProps){
                    params={ ...params, ...props.scratchpadBEsList.sendProps};
    ...
    let addRec=(...args)=>{
        ...
        if (props){
            if (props.scratchpadBEAdd){
                if (props.scratchpadBEAdd.sendProps){
                    params={ ...params, ...props.scratchpadBEAdd.sendProps};
