...
let ApiInst={
    init : (params, cbp)=>{
        ...
        //var stat=fs.lstatSync("./modules");
        //let filespath="./modules"
        ...
        feach(auto_mod_folders , function(file,i){ // if starts with  l_node_modules_auto_ then auto load file in 
            ...
            mds=ApiInst.autoLoadModules(temp_DIR,{ vserv :  settings });
        ...
        var gl_bundle={ app : app,express : express,mds :mds , 
            vserv : { settings }, params : params, pub : pub  ,http : http , io : io}
        var dyn_routes={}
