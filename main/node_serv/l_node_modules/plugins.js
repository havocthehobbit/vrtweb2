...
let main={
    init : (params)=>{
        ...
        if (!fs.existsSync(plugins_path_cust)){
            fs.mkdirSync(plugins_path_cust)
        }
                                ...
                                case "install":
                                    ...
                                    if (true){
                                        ...
                                        if (error===false){
                                            ...
                                            res.jsonp({ data : {  installed : retData} , status : "success" ,bStatus : true, err : ""});     

                                        }else{

                                            res.jsonp({ data : {} , status : "failed" ,bStatus : false, err : err});     
